...
CorrectUsername = "unique-nikesh"
CorrectPassword = "nikesh-bedari"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://youtu.be/y8SfVqjOjEE')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.youtube.com/channel/UCrjGaIUm6rrZKTsXi0JpjEw')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/c/TheVileTechs')
